...
class MenuController extends Controller
{
    ...
    public function order($idMenu, $idSwap)
    {
        ...
        try {
            ...
            return redirect(route('menu.index'))->with('pesan', ['success', 'Gagal ubah urutan menu']);
    ...
    public function prosesTambah(Request $request)
    {
        ...
        try {
            ...
            return redirect(route('menu.index'))->with('pesan', ['success', 'Gagal tambah menu']);
    ...
    public function hapus($id)
    {
        ...
        try {
            ...
            return redirect(route('menu.index'))->with('pesan', ['success', 'Gagal hapus menu']);
    ...
    public function prosesUbah(Request $request)
    {
        ...
        try {
            ...
            return redirect(route('menu.index'))->with('pesan', ['success', 'Gagal ubah menu']);
