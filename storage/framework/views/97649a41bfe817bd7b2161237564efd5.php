...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('page.index')); ?>">
                <i class="fas fa-fw fa-table"></i>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('dashboard.resetPassword')); ?>">
...
<?php /**PATH D:\tugaskuliah\2023\semester4\RPL\latihan1\resources\views/backend/layout/main.blade.php ENDPATH**/ ?>