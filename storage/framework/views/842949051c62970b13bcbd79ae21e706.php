<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="<?php echo e(route('kategori.prosesTambah')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('backend/layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tugaskuliah\2023\semester4\RPL\latihan1\resources\views/backend/content/kategori/formTambah.blade.php ENDPATH**/ ?>