            ...
            <div class="card-body">
                <form action="{{route('berita.prosesUbah')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <p></p>
                        <img id="preview" onerror="this.onerror=null;this.src='http://127.0.0.1:8000images/depositphotos_318221368-stock-illustration-missing-picture-page-for-website.jpg';" src="{{route('storage',$berita->gambar_berita)}}" alt="" width="15%">
